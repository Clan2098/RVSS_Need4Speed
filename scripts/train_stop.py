...
train_ds = StopDataSet(os.path.join(script_path, '..', 'data', 'train_stop_signs'), '.jpg', transform)
...
val_ds = StopDataSet(os.path.join(script_path, '..', 'data', 'val_stop_signs'), '.jpg', transform)
...
optimizer = optim.Adam(stop_net.parameters(), lr=0.001)
